...
use ProyectoWeb\app\controllers\ThankController;
...
$app->get('/cart/thankyou', ThankController::class . ':thankyou')->setName("cart-thankyou");
$app->get('/cart/update/json/{id:[0-9]+}[/{quantity:[0-9]+}]', CartController::class . ':update')->setName("cart-update-json");
